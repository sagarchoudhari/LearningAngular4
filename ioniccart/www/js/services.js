...
.factory('sharedFilterService', [function(){
	...
	var obj = {};
    obj.str = "http://localhost/ioniccart/SERVER_SIDE/food_menu.php?till=";
	obj.sort = "";
	obj.search = "";
	obj.category = "";
	obj.till=0;
	...
	obj.getUrl=function(){
		...
		obj.till=obj.till + 5;
		obj.str="http://localhost/ioniccart/SERVER_SIDE/food_menu.php?till="+obj.till; // pass the value to url
